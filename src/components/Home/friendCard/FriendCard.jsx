...
const FriendCard = ({ friend }) => {
  ...
  return (
   <Link to={`/${friend.id}`}
      className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 flex flex-col items-center text-center max-w-70 w-full hover:shadow-md transition-shadow">
